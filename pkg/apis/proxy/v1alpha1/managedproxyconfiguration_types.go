...
func (in Toleration) ToCoreV1() v1.Toleration {
	out := v1.Toleration{
		Key:      in.Key,
	...
	if in.TolerationSeconds != nil {
		tolerationSeconds := *in.TolerationSeconds
		out.TolerationSeconds = &tolerationSeconds
	}
	return out
}
...
type ManagedProxyConfigurationProxyAgent struct {
	...
	// +optional
	AdditionalServiceProxyArgs []string `json:"additionalServiceProxyArgs,omitempty"`
